...
Earlier this week I read a new essay by [Benjamin Mako Hill](http://mako.cc/) called “[When Free Software Isn’t Better](http://mako.cc/writing/hill-when_free_software_isnt_better.html).” Although I found it incredibly insightful, the reaction to this essay hasn’t been universally positive. The criticism has focused on a perceived attack on the Open Source Initiative. I want to address why I think Mako has taken a stance here that’s not aligned with the OSI, and why I also think it doesn’t constitute an attack.
...
- the “[four freedoms](https://secure.wikimedia.org/wikipedia/en/wiki/Free_software#Definition)” to run, study, distribute, and improve software;
...
That idea resonates deeply with me as a user of free software. I grappled with a tension between a commitment to free software being better and my hands-on experience with lots of it which, to put it bluntly, isn’t. It was after seeing Mako speak about “[antifeatures](http://www.fsf.org/bulletin/2007/fall/antifeatures/)” at [Free Culture X](http://freeculture.org/) last year, a talk which held the seeds of this essay in it, that I realized the reason I stick with free software when it isn’t better is because it’s free.

There was a time, certainly around the 1998 founding of the Open Source Initiative and especially in the “[nobody ever got fired for buying IBM](https://secure.wikimedia.org/wikipedia/en/wiki/Fear,_uncertainty_and_doubt)” world of enterprise IT, when free software was not an option even when it was better than the proprietary alternative. Now, due in large part to the efforts of the FSF and the OSI, that’s not the case any more.
