...
Several months ago, I decided that the most responsible relationship to have with Facebook was none at all. I deactivated my account. After a rocky five years of ups and downs, I just couldn’t take their [arcane](https://www.nytimes.com/interactive/2010/05/12/business/facebook-privacy.html) and [irresponsible positions](http://mattmckeon.com/facebook-privacy/) on privacy.

But now, as so often happens after a sudden break-up like ours, “it’s complicated.”

My hasty de-activation underestimated the benefits of using Facebook, and moving to a new city after college has brought these into the foreground for me. There are many people I consider friends for whom I don’t really have contact information. Birthdays are much harder to remember and acknowledge. I miss invitations or details for other events. Most important, though, not having a Facebook account has affected my ability to do [my job](https://www.facebook.com/soundcloud). Separation from the cruel mistress with 500 million lovers wasn’t working out, and that means I had to go back to the drawing board on the service.
...
The problems with privacy and security multiply with the introduction of Facebook products that aren’t contained to their own website. [Beginning with the ill-fated Beacon advertising program](http://bits.blogs.nytimes.com/2007/11/29/the-evolution-of-facebooks-beacon/), each of their attempts to engage the social graph outside of the pages of Facebook have had major problems. In the case of Beacon, those problems [prevented the program from being successful](http://www.beaconclasssettlement.com/), but the success of later projects shouldn’t be taken as an indicator that they’re built on more sound foundations–the “Like Button” that has been adopted by hundreds of thousands of websites has[ problems that have been well documented](http://edition.cnn.com/2010/TECH/social.media/06/02/cnet.facebook.privacy.like/index.html).
...
YourOpenBook.org has put together [a simple proposal for changes Facebook could easily implement](http://youropenbook.org/proposal.html#1) to make their privacy policies less opaque and problematic. The EFF has published [an open letter calling for Facebook to make specific improvements](https://www.eff.org/press/archives/2010/06/16). Epic (and a bunch of other organizations) [called for the FTC to examine Facebook’s privacy policies](http://epic.org/privacy/inrefacebook/#complaint), and [Congress has gotten involved](http://judiciary.house.gov/news/100528.html). These kinds of actions need public attention, and Facebook needs to know these are issues people care about. Tell your friends about these issues, and make sure to voice your opinion.

#### Support alternatives

There are ways to set up a social network that don’t compromise your privacy or freedom. [Diaspora](http://www.joindiaspora.com/) became the most prominent alternative to Facebook in development, and its code is slated to be released in a few days, but it is not the only possibility. A group of hackers have [worked on putting together the “Freedom Box”](http://foocorp.net/projects/fooplug/) described in [the same Eben Moglen talk](http://www.isoc-ny.org/?p=1338) that inspired the Diaspora team. [Status.Net](http://status.net) and [Identi.ca](http://identi.ca) are valuable free alternatives for some of the features Facebook provides.
