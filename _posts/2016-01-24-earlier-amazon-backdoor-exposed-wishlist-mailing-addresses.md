...
I contacted [Amazon Security](http://www.amazon.com/gp/help/customer/display.html/ref=hp_left_sib?ie=UTF8&nodeId=201182150) via email, ((They make a PGP key available, but [only distribute it over unauthenticated HTTP](http://www.amazon.com/gp/help/customer/display.html?nodeId=200724850). All the more reason Amazon should switch to entirely HTTPS.)) and got a confirmation number and a response from a human that it had been assigned to somebody. The fix, introduced in May, seems to simply removed the second confirmation email direct from Canada Post.
