...
Anyway, it works through [a little Javascript plug-in called Emphasis](http://open.blogs.nytimes.com/2011/01/11/emphasis-update-and-source/), developed in-house at the Times and [released open-source](https://github.com/NYTimes/Emphasis) ((with no obvious license, alas)). I poked around a little bit and found that a developer named Ben Balter has released [a WordPress plugin to implement Emphasis on blogs](https://wordpress.org/extend/plugins/wp-emphasis/), and so I decided to give it a spin. Now you can link to any paragraph and highlight any sentence in any post: just hit shift twice and click the pilcrow or the sentence and the URL bar will update.
