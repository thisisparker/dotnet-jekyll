...
How could inconvenience be a selling point to a publisher? It’s because they fear [bundle failure](https://parkerhiggins.net/2012/03/britannica-bookstores-and-bundled-values/). Publishers have always been able to [bundle the text of a book (the "content") with a physical volume (the "container")](http://questioncopyright.org/understanding_free_content). When that’s the case, selling books is almost like selling any other physical object, with infrastructure in place for designing, manufacturing, distributing, and selling at retail. Convenient e-books threaten to unsettle that arrangement — they make attractive the idea of consuming just the publisher’s content, and not its container.
...
One shortsighted answer presumes that the value of an e-book is the value of a hardcover minus the perceived cost of printing. This premise, in fact, informs the e-book pricing strategy of most publishers. But it’s both incorrect and dangerous. It leads to the strategic error of situating e-books as [substitute goods](https://en.wikipedia.org/wiki/Substitute_good), instead of [complementary goods](https://en.wikipedia.org/wiki/Complementary_good), for a publisher’s other offerings.
...
DRM renders [user innovation](https://en.wikipedia.org/wiki/User_innovation) difficult at best, and so limits the possibility of runaway demand. And it [makes the e-book, the closest thing yet to the content alone, *less* valuable](http://blog.grossmeier.net/2012/03/25/why-i-dont-buy-ebooks-anymore/). Taken together, that means missed opportunities for publishers and authors.