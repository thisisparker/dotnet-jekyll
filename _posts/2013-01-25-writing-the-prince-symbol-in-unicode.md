...
<div markdown="1" style="float:right;">![Prince_logo.svg](https://parkerhiggins.net/wp-content/uploads/2013/01/Prince_logo.svg_.png)
</div>
...
The end result, which will only work if you’re viewing this page in UTF-8 and have proper font support[^1] is Ƭ̵̬̊. Rendered large, that’s:  
...
[^1]: If you don’t have the right font, I can recommend [Symbola](http://users.teilar.gr/~g1951d/)
