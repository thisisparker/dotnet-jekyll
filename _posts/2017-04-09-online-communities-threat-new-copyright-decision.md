...
A [Ninth Circuit copyright decision](https://www.eff.org/files/2017/04/08/mavrix-livejournal-9thcir.pdf) in *Mavrix v. LiveJournal* could bring nasty implications for online communities, threatening the copyright “safe harbor” provisions that allows those communities to form.
...
The Ninth Circuit decision kicking it back down to the district court means that these questions are very much in play. And it could already mean, as EFF puts it, that [using moderators means you will have to go all the way to trial](https://www.eff.org/deeplinks/2017/04/ninth-circuit-sends-message-platforms-use-moderator-go-trial).
