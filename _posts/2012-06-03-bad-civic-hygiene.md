...
He’s used the line in a few essays: one about [data reuse and the role of the US census in Japanese internment](https://www.schneier.com/blog/archives/2007/06/risks_of_data_r.html), one about [Chinese pornography filters that snoop on Internet users](https://www.schneier.com/essay-281.html), and one about [a failed Obama administration proposal for backdoors in encryption systems](https://www.schneier.com/blog/archives/2010/09/wiretapping_the.html), for example.
...
That’s why the "hygiene" metaphor is so apt. Good hygiene isn’t mandated by law, but people understand that it’s an important practice. It makes cooperation with society smoother, and reduces the prevalence of [parasites as systems get increasingly complex](http://craphound.com/complexecosystems.txt).

One example: companies that track users across the web often defend the practice by explaining the virtues of their primary purpose. They may help monetize free content, or deliver more customized materials to users, or something else that society considers beneficial. But these arguments miss the point. Obviously, if the primary purpose is bad for society, it’s a short conversation that ends there. Even in the case of a compelling primary purpose, though, having a good [security mindset](https://www.schneier.com/blog/archives/2008/03/the_security_mi_1.html) means thinking about the ways a system can fail. Allowing a society to inch towards a police state is a pretty serious failure. (("[Harmless failures](https://freedom-to-tinker.com/blog/felten/security-mindset-and-harmless-failures/)" are bad too. Ed Felten refers to those also as bad hygiene.))
